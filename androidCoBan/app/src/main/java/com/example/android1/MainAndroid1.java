...
public class MainAndroid1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.android1);
        ...
        ASM.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intentlab = new Intent(MainAndroid1.this, ASM1.class);
        ...
        btn2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intentlab = new Intent(MainAndroid1.this, Lab2.class);
                startActivity(intentlab);
            }
        });
        btn3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intentlab = new Intent(MainAndroid1.this, Lab3.class);
                startActivity(intentlab);
            }
        });
        btn4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intentlab = new Intent(MainAndroid1.this, Lab4Menu.class);
                startActivity(intentlab);
            }
        });
        btn7.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intentlab = new Intent(MainAndroid1.this, Lab7.class);
                startActivity(intentlab);
            }
        });
        btnBai3la.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intentlab = new Intent(MainAndroid1.this, Bai3la.class);
                startActivity(intentlab);
            }
        });
        btnThi.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intentThi = new Intent(MainAndroid1.this, Activity.class);
